    ...
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10 relative">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Discover the latest and exclusive styles tailored just for you to keep
          you wardrobe fresh & stylish
        </p>
        {/* scroll buttons */}
      ...
      >
        {newArrivals.map((product) => (
          ...
          >
            ...
            />
            <div
              className="absolute bottom-0 left-0 right-0 bg-gray-500/30 backdrop-blur-md text-white 
              p-4 rounded-b-lg"
            >

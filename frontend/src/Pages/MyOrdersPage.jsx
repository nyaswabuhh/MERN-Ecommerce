    ...
    setTimeout(() => {
      const mockOrders = [
        ...
        },
        {
          _id: "32343",
          createdAt: new Date(),
          shippingAddress: { city: "Kisumu", country: "Kenya" },
          orderItems: [
            {
              name: "Product 2",
      ...
      <div className='relative shadow-md sm:rounded-lg overflow-hidden'>
        <table className='min-w-full text-left text-gray-500' >
          ...
          <tbody>
            {orders.length > 0 ? (
              orders.map((order)=>(
                <tr key={order._id} className='border-b hover:border-gray-50 cursor-point'>
                  <td className='py-2 px-2 sm:py-4 sm:px-4'>
                    <img 
                    src={order.orderItems[0].image} alt={order.orderItems[0].image}
              ...
              <tr>
                <td className='colspan-7 py-4 px-4 text-center text-gray-500'>
                You have no orders
                </td>
              </tr>
